...
class UserSME(UserMixin, Base):
    ...
    WAContact = Column("WAContact", String(24))

    industry_type = Column("industry_type", String(256))
...
class UserSHG(UserMixin, Base):
    ...
    SHG_Name = Column("SHG_Name", String(256))
    industry_type = Column("industry_type", String(256))
    prod_capacity = Column("prod_capacity", String(256))
    order_size = Column("order_size", String(256))
    image_uri = Column("image_uri", String(256))
